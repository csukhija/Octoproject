...
function hideChild(ele)
{
   ...
   for(i = 0; i < nodes.length; i++)
   {
      if(nodes[i].tagName == "TABLE")
      {
         ...
         ele.src = (minimizing ? "/static/images/searchtable/max.gif" : "/static/images/searchtable/min.gif");
